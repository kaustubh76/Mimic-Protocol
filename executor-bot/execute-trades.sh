...
# Configuration
RPC="${MONAD_RPC_URL:-https://monad-testnet.g.alchemy.com/v2/pFkOAygOyJ72KbT_I-LM0}"
EXECUTION_ENGINE="${EXECUTION_ENGINE_ADDRESS:-0x4364457325CeB1Af9f0BDD72C0927eD30CB69eD8}"
DELEGATION_ROUTER="${DELEGATION_ROUTER_ADDRESS:-0xd5499e0d781b123724dF253776Aa1EB09780AfBf}"
BEHAVIORAL_NFT="${BEHAVIORAL_NFT_ADDRESS:-0x6943e7D39F3799d0b8fa9D6aD6B63861a15a8d26}"
GRAPHQL_ENDPOINT="${ENVIO_GRAPHQL_URL:-https://indexer.dev.hyperindex.xyz/4cda827/v1/graphql}"
...
MOCK_DEX="${MOCK_DEX_ADDRESS:-0x8108e615e7858f246f820eae0844c983ea5e9a12}"  # Deployed MockDEX
