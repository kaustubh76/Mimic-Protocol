...
/**
 * Context interface (provided by Envio)
 * This will be auto-generated by Envio codegen
 */
interface Context {
  Pattern: {
...
/**
 * Event interfaces (will be auto-generated by Envio)
 */
interface PatternMintedEvent {
  tokenId: bigint;
  creator: string;
  patternType: string;
  patternData: string;
...
interface PatternPerformanceUpdatedEvent {
  tokenId: bigint;
  winRate: bigint;
  totalVolume: bigint;
  roi: bigint;
...
interface PatternDeactivatedEvent {
  tokenId: bigint;
  reason: string;
  blockNumber: bigint;
  transactionHash: string;
...
export async function handlePatternMinted(
  ...
  try {
    const { tokenId, creator, patternType, patternData, timestamp, blockNumber, transactionHash } =
      event;
 ...
 * Performance Target: <10ms execution time
 */
export async function handlePatternPerformanceUpdated(
  event: PatternPerformanceUpdatedEvent,
  context: Context
): Promise<void> {
  ...
  try {
    ...
    const duration = timer.stopAndCheckTarget(
      10,
      `PerformanceUpdated handler for #${tokenId}`
    );
 ...
 * Performance Target: <10ms execution time
 */
export async function handlePatternDeactivated(
  event: PatternDeactivatedEvent,
  context: Context
): Promise<void> {
 ...
 * @param context - Database context
 */
export async function handleTransfer(event: TransferEvent, context: Context): Promise<void> {
