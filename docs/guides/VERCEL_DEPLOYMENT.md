...
|----------|-------|---------|
| `VITE_ENVIO_GRAPHQL_URL` | `https://indexer.dev.hyperindex.xyz/b1106ec/v1/graphql` | Envio HyperSync endpoint |
  ...
  "rewrites": [
    {
      ...
      "destination": "https://indexer.dev.hyperindex.xyz/b1106ec/v1/:path*"
    }
  ]
}
```
